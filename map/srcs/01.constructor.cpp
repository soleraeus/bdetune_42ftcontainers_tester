...
int	main(int ac, char **av)
{
	...
	{
		volatile int x = 0;
		std::cout << "*******   int, int map empty constructor   *******" << std::endl;
		...
		std::cout << "*******   std::string, std::string map empty constructor  *******" << std::endl;
		for (volatile int i = 0; i < 100; i++)
		{
		...
		std::cout << "*******   ConstClass<int>, ConstClass<int> map empty constructor   *******" << std::endl;
		for (volatile int i = 0; i < 100; i++)
		{
